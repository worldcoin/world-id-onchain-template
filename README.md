...
This is a sample smart contract & demo app that uses World ID on the [Test network](https://id.worldcoin.org/test). It works together with World ID's [Javascript Integration](https://docs.worldcoin.org/idkit).
...
- Get an Infura project ID from [Infura](https://infura.io/).

- Get a World ID App ID from [Worldcoin Developer Portal](https://developer.worldcoin.org/).

- Create an `.env` file with it (see [.env.sample](./.env.sample))
